    ...
    (s = s || {}).fn = {
        ...
        cotizar: function() {
            u(".cotizar").click(function() {
                ...
                "0" != e && null != e && window.open(e, "_blank")
            })
        },
        imprimir: function() {
        ...
        escoger: function() {
            ...
            u("#filter-asientos").is(":visible") && (u("#filter-asientos").slider({
                val: 3,
                min: 3,
                max: 8,
                slide: function(e, t) {},
            ...
            u("#filter-combustibles,#filter-categorias").on("change", function() {
                if (0 == d) {
                    var e = u("#filter-capacidad").slider("value") + "k",
                ...
                if (0 == d) {
                    var o = u("#filter-capacidad").slider("value") + "k",
                        i = u("#filter-combustibles").val(),
                        a = u("#filter-categorias").val();
                    if (3 == u("#filter-asientos").slider("value")) var r = 0;
                ...
                1 == (d = !0) && u.ajax({
                    ...
                    success: function(e) {
                        u("#filter-categorias").val("0").trigger("change"), u("#filter-combustibles").val("0").trigger("change"), u("#filter-asientos").slider("value", 0), u("#filter-capacidad").slider("value", 0), u(".resultados-filtros").html(e), s.fn.reiniciarSeleccionComparar(), u(".btn-comparar").on("click", function() {
                            n = this, s.fn.seleccionarComparar(n)
                        }), d = !1
                    }
                })
        ...
        verEspecificaciones: function() {
            var t, a;
            jQuery(".node-type-modelos-detalle .btn-especificacion").on("click", function() {
                jQuery(this).attr("data-nid");
                var e = jQuery(this).attr("data-tid"),
                    i = u(this).parent().parent().find("h3").html();
                u.ajax({
                    type: "GET",
                    ...
                    success: function(e) {
                        jQuery(".data-especificaciones").html(e), jQuery(".nombre-modelo").html(i), a = jQuery(".data-especificaciones table tr td");
                        for (var t = 0; t < a.length; t++) {
                            var o = a[t];
                            "--" == jQuery(o).html() && jQuery(o).parent().remove()
                        }
                    }
                }), u(".bloque-especificaciones").addClass("open")
            }), u(".bloque-especificaciones .close").on("click", function() {
                u(".bloque-especificaciones").removeClass("open")
            }), jQuery(".node-type-modelos-detalle .btn-especificacion").click(function() {
        ...
        pintarComparar: function() {
            for (var e = u(".btn-comparar"), t = 0; t < e.length; t++) {
                var o = e[t];
                0 <= a.indexOf(u(o).parent().parent().parent().attr("data-tid")) && u(o).addClass("active")
            }
        },
        seleccionarComparar: function(e) {
            a.length <= 2 ? 0 <= a.indexOf(u(e).parent().parent().parent().attr("data-tid")) ? (a.splice(a.indexOf(u(e).parent().parent().parent().attr("data-tid")), 1), u(e).removeClass("active")) : (a.push(u(e).parent().parent().parent().attr("data-tid")), u(e).addClass("active")) : 0 <= a.indexOf(u(e).parent().parent().parent().attr("data-tid")) && (a.splice(a.indexOf(u(e).parent().parent().parent().attr("data-tid")), 1), u(e).removeClass("active")), u("#btn-comparar-especificacion .number").html(a.length)
        },
        comparador: function() {
        ...
        slider: function() {
            ...
            }), u(".node-type-modelos-detalle").is(":visible") && u(window).width() < c && (u(".node-type-modelos-detalle .carousel-modelos.owl-carousel").owlCarousel("destroy"), u(".node-type-modelos-detalle .carousel-modelos.owl-carousel").removeClass("owl-carousel")), u(".bloque-modelos-home select.modelo").on("change", function() {
        ...
        modelos: function() {
            u(".bloque-modelos .container-filters-red  ul li").click(function() {
                u(".bloque-modelos .container-filters-red  ul li").removeClass("active"), u(this).addClass("active")
        ...
        setMarkers: function() {
            ...
            for (t = 0; t < f.length; t++) {
                ...
                var i, a, r = "<li data-lat='" + f[t].lat + "' data-lng='" + f[t].long + "'><div class='col-md-7 col-sm-6 col-xs-12'><h5>" + f[t].nombre + "</h5><p class='info-txt'><p class='direccion_conces'>" + f[t].direccion + "</span> <p class='tel_conces'> TEL:" + f[t].telefono + "</p> <p class='fax_conces'>FAX:<span class='txt'>" + f[t].fax + "</span> </p><p class='horario_conces'>Horario: <span class='txt'>" + f[t].horario + "</span></p><a class='enlace_conces' target='_blank' href='" + f[t].web + "'>" + f[t].web + "</a></p></div><div class='col-md-5 col-sm-6 col-xs-12'><ul class='list-servicios" + t + "'></ul></div></li>";
                ...
                u(d).on("click", function(r, n) {
                    return function() {
                        var e = "https://www.google.com/maps/dir/?api=1&destination=" + f[n].lat + "," + f[n].long,
                            t = "<div class='info-map'><img src='" + f[n].logo + "' class='img-responsive'><h3>" + f[n].nombre + "</h3><p>" + f[n].direccion + "</p><p class='tel_marker'>TEL: <span class='txt'>" + f[n].telefono + "</span></p><p class='fax_marker'>FAX: <span class='txt'>" + f[n].fax + "</span></p><p class='horario_marker'>Horario: <span class='txt'>" + f[n].horario + "</span></p><a class='link_marker' target='_blank' href='" + f[n].web + "'>" + f[n].web + "</a><a class='link-map' target='_blank' href='" + e + "'>¿Cómo llegar?</a><ul class='lista-map'></ul></div>";
        ...
        formsValidation: function() {
                ...
                var e = jQuery(this).val(),
                    ...
                    u.ajax({
                        ...
                        success: function(o) {
                            ...
                            }), "" != e && (u("#edit-submitted-datos-del-vehiculo-modelo option[value=" + e + "]").attr("selected", "selected"), jQuery("#edit-submitted-datos-del-vehiculo-modelo").change()), jQuery("select").selectpicker("refresh")
                        }
                    }), 
            ...
            u("#cotizar-calculadora").click(function(e) {
            ...
            }), u("#edit-submitted-email").attr("maxlength", "40"), u(".paso1 button").click(function(e) {
                ...
                u("#edit-submitted-f1-celular").removeAttr("required"), u("#edit-submitted-f1-celular").removeClass("required"), u("#edit-submitted-f1-celular").removeClass("parsley-error"), u("#edit-submitted-f1-celular").parent().find(".parsley-errors-list").remove()
            }), u("#edit-submitted-f1-celular").keyup(function() {
                u("#edit-submitted-f1-telefono").removeAttr("required"), u("#edit-submitted-f1-telefono").removeClass("required"), u("#edit-submitted-f1-telefono").removeClass("parsley-error"), u("#edit-submitted-f1-telefono").parent().find(".parsley-errors-list").remove()
            }), u("#edit-submitted-f1-telefono").attr("data-parsley-type", "number"), u("#edit-submitted-f1-telefono").on("input", function() {
                this.value = this.value.replace(/[^0-9]/g, "")
            }), u("#edit-submitted-f1-telefono").attr("maxlength", "7"), u("#edit-submitted-f1-telefono").attr("minlength", "7"), u("#edit-submitted-f1-telefono").attr("data-parsley-error-message", "El teléfono debe ser de 7 caracteres."), u("#edit-submitted-f1-celular").attr("data-parsley-type", "number"), u("#edit-submitted-f1-celular").on("input", function() {
                this.value = this.value.replace(/[^0-9]/g, "")
            }), u("#edit-submitted-f1-celular").attr("maxlength", "9"), u("#edit-submitted-f1-celular").attr("minlength", "9"), u("#edit-submitted-f1-celular").attr("data-parsley-error-message", "El celular debe ser de 9 caracteres."), l = u(".paso"), u(".formulario .previous").click(function() {
        ...
        goTo: function() {
            u(".bloque-conocelo .container-filters-red ul.filters li").on("click", function() {
                ...
                var e = u("." + u(this).attr("id")).offset().top - u(".header").height();
                u("html, body").animate({
                    scrollTop: e
                }, 1e3)
        ...
        init: function() {
            u(document).on("ready", s.documentOnReady.init), u(window).on("load", s.documentOnLoad.init), u(window).on("resize", s.documentOnResize.init), u(window).on("scroll", s.documentOnScroll.init)
        }
    }, s.run.init()
}($);
